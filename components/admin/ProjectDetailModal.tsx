          ...
          <div>
            ...
            <div className="mb-6 space-y-2">
              <span className="text-[10px] font-mono tracking-widest text-blue-400 font-bold uppercase flex items-center gap-1.5">
                <Terminal size={11} /> {project.category} // Project Overview
              </span>
              <p className="text-xs md:text-sm leading-relaxed text-gray-300 font-normal text-justify">{project.full_description || project.description}</p>
            </div>
            ...
            <div className="mb-8 space-y-2.5">
              ...
              <div className="flex flex-wrap gap-2">
                {getTechArray(project.tech_stack).map((tag, tIdx) => (
                  <div
                    key={tIdx}
                    className="flex items-center gap-1.5 rounded-lg bg-white/[0.03] border border-white/10 px-3 py-1.5 text-[10px] font-mono font-medium text-gray-300 hover:border-cyan-500/30 transition-all uppercase"
                  >
